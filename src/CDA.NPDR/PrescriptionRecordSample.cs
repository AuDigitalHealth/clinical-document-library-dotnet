...
namespace Nehta.VendorLibrary.CDA.NPDR.Sample
{
    ...
    public class PrescriptionRecordSample
    {
        ...
        {
            get { return OutputFolderPath + @"\PCEHRPrescriptionRecord.xml"; }
        }
        ...
        internal static PCEHRPrescriptionRecord PopulatePrescriptionRecord(Boolean mandatorySectionsOnly)
        {
            ...
            else
            {
                ...
                {
                    CreateParentDocument(ReleatedDocumentType.Transform, null, "1.2.36.1.2001.1005.50.8003620833333789", BaseCDAModel.CreateGuid(), null, null, mandatorySectionsOnly),
                    CreateParentDocument(ReleatedDocumentType.Replace, cdaContext.SetId, BaseCDAModel.CreateOid(), null, CDADocumentType.PrescriptionRecord, "1", mandatorySectionsOnly),
                };
            }
            ...
            prescriptionRecord.SCSContext.PrescriberOrganisation =
                CreatePrescriberOrganisation(mandatorySectionsOnly, prescriberOrganisationId);

            prescriptionRecord.SCSContext.SubjectOfCare = BaseCDAModel.CreateSubjectOfCare();
            GenericObjectReuseSample.HydrateSubjectofCare(prescriptionRecord.SCSContext.SubjectOfCare,
                mandatorySectionsOnly, false);
            ...
            // Prescription Item
            prescriptionRecord.SCSContent.PrescriptionItem =
                CreatePrescriptionItem(mandatorySectionsOnly, BaseCDAModel.CreateGuid());
        ...
        internal static IPCEHRPrescriptionItem CreatePrescriptionItem(Boolean mandatorySectionsOnly,
            string prescriptionId)
        {
            ...
            prescriptionItem.PrescriptionItemIdentifier =
                BaseCDAModel.CreateIdentifier("1.2.36.1.2001.1005.36", BaseCDAModel.CreateGuid());
            ...
            if (!mandatorySectionsOnly)
            {
                ...
                prescriptionItem.TherapeuticGoodId = BaseCDAModel.CreateCodableText("01158Y", CodingSystem.PBSCode,
                    "cimetidine 400 mg tablet, 60", null, null);
                ...
                prescriptionItem.Form = BaseCDAModel.CreateCodableText("385057009", CodingSystem.SNOMED,
                    "Film-coated tablet", null, null);
                ...
                prescriptionItem.Route =
                    BaseCDAModel.CreateCodableText("26643006", CodingSystem.SNOMED, "Oral route", null, null);
                ...
                prescriptionItem.PBSManufacturerCode =
                    BaseCDAModel.CreateExternalConceptIdentifier(ExternalConcepts.AustralianPBSManufacturerCode, "AB");
            }
            else
            {
                // Therapeutic Good Identification - The medicine, vaccine or other therapeutic good being ordered, administered to or used by the subject of care
                prescriptionItem.TherapeuticGoodId = BaseCDAModel.CreateCodableText("28237011000036107",
                    CodingSystem.AMTV3, "amoxycillin 500 mg capsule, 20", null, null);
            }
        ...
        internal static DispensingInformation CreateDispensingInformation(Boolean mandatorySectionsOnly)
        {
            ...
            if (!mandatorySectionsOnly)
            {
                ...
                dispensingInformation.MinimumIntervalBetweenRepeats =
                    BaseCDAModel.CreateInterval("1", TimeUnitOfMeasure.Week);
            }
        ...
        internal static IParticipationPrescriber CreatePrescriber(Boolean mandatorySectionsOnly, Guid prescriberId)
        {
            ...
            Example of how to get ENUM value to store in DB and then getting ENUM back from value

            // Getting the Name and Code
            var occName = prescriber.Participant.Person.Occupation.Value.GetAttributeValue<NameAttribute, String>(x => x.Name);
            var occValue = prescriber.Participant.Person.Occupation.Value.GetAttributeValue<NameAttribute, String>(x => x.Code);

            var occupation = new Occupation();
            foreach (var item in Enum.GetValues(typeof(Occupation)))
            {
                if (((Occupation)item).GetAttributeValue<NameAttribute, string>(x => x.Code) == occValue)
                {
           ...
           */
            ...
            if (!mandatorySectionsOnly)
            {
                ...
                prescriber.Participant.ElectronicCommunicationDetails =
                    new List<ElectronicCommunicationDetail> {coms1, coms2};

                // Prescriber > Participant > Entitlement
                var entitlement1 = BaseCDAModel.CreateEntitlement();

                entitlement1.Id = BaseCDAModel.CreateIdentifier(
                    IdentifierType.PrescriberNumber.GetAttributeValue<NameAttribute, String>(x => x.Name),
                    null,
                    "1423444",
        ...
        internal static IParticipationPrescriberOrganisation CreatePrescriberOrganisation(Boolean mandatorySectionsOnly,
            Guid prescriberOrganisationId)
        {
            ...
            if (!mandatorySectionsOnly)
            {
                ...
                {
                    BaseCDAModel.CreateElectronicCommunicationDetail("0712341234",
                ...
                (
                    ...
                    "455458",
                    "1.22.333.444.55575",
                    BaseCDAModel.CreateCodableText("1.1.1.1.1.1", CodingSystem.NCTIS, "DisplayName", "Original Text",
                        null)
                );
        ...
        internal static IParticipationLegalAuthenticator CreateLegalAuthenticator(Boolean mandatorySectionsOnly,
            Guid legalAuthenticatorId)
        {
            ...
            authenticator.Participant.DateTimeAuthenticated =
                new ISO8601DateTime(DateTime.Now, ISO8601DateTime.Precision.Minute);

            // LegalAuthenticator/assignedEntity/assignedPerson
            authenticator.Participant.Person = BaseCDAModel.CreatePerson();

            var localAuthorityCode =
                BaseCDAModel.CreateCodableText("EI", CodingSystem.HL7IdentifierType, null, null, null);
            ...
            if (!mandatorySectionsOnly)
            {
                ...
                var coms2 = BaseCDAModel.CreateElectronicCommunicationDetail(
                    ...
                    ElectronicCommunicationMedium.Email,
                    ElectronicCommunicationUsage.WorkPlace);
                authenticator.Participant.ElectronicCommunicationDetails =
                    new List<ElectronicCommunicationDetail> {coms1, coms2};
        ...
        internal static IParticipationCustodian CreateCustodian(Boolean mandatorySectionsOnly, Guid custodianId)
        {
            ...
            if (!mandatorySectionsOnly)
            {
                ...
                var coms1 = BaseCDAModel.CreateElectronicCommunicationDetail("0712341234",
                    ElectronicCommunicationMedium.Telephone, ElectronicCommunicationUsage.WorkPlace);
