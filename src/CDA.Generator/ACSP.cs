...
{
    /// <summary>
    /// This ACSP object is a composition of the context and content objects that define
    /// a CDA ACSP document
    /// 
    /// This object is also responsible for providing the factory methods used to instantiate any ACSP
    /// objects that are required to build a valid ACSP CDA document
    /// </summary>
    [DataContract]
    ...
    public class ACSP : BaseCDAModel
    {
        #region Properties
        /// <summary>
        ...
        public ACSP(DocumentStatus documentStatus)
        {
        ...
        /// set to final
        /// </summary>
        public ACSP() : this(DocumentStatus.Final)
        {
        }
        #endregion
        ...
        /// Creates an ACSP
        /// </summary>
        /// <returns>ACSP</returns>
        public static ACSP CreateACSP()
        {
            return new ACSP();
        }
        ...
        /// </summary>
        /// <returns>ICDAContextACSP</returns>
