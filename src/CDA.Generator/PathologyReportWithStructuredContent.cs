...
namespace Nehta.VendorLibrary.CDA.Common
{
  ...
  public class PathologyReportWithStructuredContent : BaseCDAModel
  {
    ...
    /// </summary>
    [DataMember]
    public ICDAContextPathologyReportWithStructuredContent CDAContext { get; set; }

    /// <summary>
    /// An IPathologyResultReportContent that contains the content for this Pathology Result Report record
    /// </summary>
    [DataMember]
    public IPathologyReportWithStructuredContentContent SCSContent { get; set; }

    /// <summary>
    /// An IPathologyResultReportContext that contains the context for this Pathology Result Report record
    /// </summary>
    [DataMember]
    public IPathologyReportWithStructuredContentContext SCSContext { get; set; }
    ...
    public PathologyReportWithStructuredContent(DocumentStatus documentStatus)
    {
    ...
    /// set to final
    /// </summary>
    public PathologyReportWithStructuredContent() : this(DocumentStatus.Final)
    {
    }
    ...
    public static PathologyReportWithStructuredContent CreatePathologyReportWithStructuredContent()
    {
        return new PathologyReportWithStructuredContent();
    }
    ...
    public static ICDAContextPathologyReportWithStructuredContent CreateCDAContext()
    {
    ...
    /// </summary>
    /// <returns>IPathologyReportWithStructuredContent</returns>
    public static IPathologyReportWithStructuredContentContext CreateSCSContext()
    {
      return new Context();
    }
    ...
    public static IPathologyReportWithStructuredContentContent CreateSCSContent()
    {
      return new Content();
    }
