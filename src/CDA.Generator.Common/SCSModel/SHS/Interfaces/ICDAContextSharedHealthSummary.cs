...
{
    /// <summary>
    /// This interface encapsulates all the CDA specific context for an SharedHealthSummary
    /// </summary>
    public interface ICDAContextSharedHealthSummary
    {
        #region Properties
        ...
        #region Validation
        /// <summary>
        /// Validates this CDA Context for this SharedHealthSummary
        /// </summary>
