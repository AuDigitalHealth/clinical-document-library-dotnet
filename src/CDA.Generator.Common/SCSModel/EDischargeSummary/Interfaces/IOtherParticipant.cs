...
{
    /// <summary>
    /// The IHealthProfessional interface encapsulates all the properties that CDA requires for an Other Participant
    /// </summary>
    public interface IOtherParticipant
        {
        /// <summary>
        ...
        /// <summary>
        /// Validates this Other Participant Participant
        /// </summary>
