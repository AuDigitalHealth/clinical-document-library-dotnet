...
{
    /// <summary>
    /// This interface encapsulates all the CDA specific context for an ICDAContextAcdCustodianRecord
    /// </summary>
    public interface ICDAContextAcdCustodianRecord
    {
        #region Properties
        ...
        #region Validation
        /// <summary>
        /// Validate the CDA Context for this ICDAContextAcdCustodianRecord
        /// </summary>
