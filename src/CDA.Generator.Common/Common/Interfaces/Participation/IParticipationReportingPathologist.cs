...
{
    /// <summary>
    /// The IParticipationReportingPathologist 
    /// </summary>
    public interface IParticipationReportingPathologist
    {
        /// <summary>
        ...
        [CanBeNull]
        [DataMember]
        IReportingPathologist Participant { get; set; }

        /// <summary>
        /// Validates this Participation Reporting Pathologist
        /// </summary>
