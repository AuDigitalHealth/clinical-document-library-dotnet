...
{
    /// <summary>
    /// This NSWHealthCheckAssessment object is a composition of the context and content objects that define
    /// a CDA NSWHealthCheckAssessment document
    /// 
    /// This object is also responsible for providing the factory methods used to instantiate any NSWHealthCheckAssessment
    /// objects that are required to build a valid NSWHealthCheckAssessment CDA document
    /// </summary>
    [DataContract]
    ...
    public class NSWHealthCheckAssessment : BaseCDAModel
    {
        #region Properties
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public ICDAContextNSWHealthCheckAssessment CDAContext { get; set; }

        /// <summary>
        /// An IEReferralContent that contains the content for this e-referral record
        /// </summary>
        [DataMember]
        public INSWHealthCheckAssessmentContent SCSContent { get; set; }

        /// <summary>
        /// An IDispenseRecordContext that contains the context for this e-referral record
        /// </summary>
        [DataMember]
        public INSWHealthCheckAssessmentContext SCSContext { get; set; }
        #endregion
        ...
        public NSWHealthCheckAssessment(DocumentStatus documentStatus)
        {
        ...
        /// set to final
        /// </summary>
        public NSWHealthCheckAssessment()
        ...
        public static NSWHealthCheckAssessment CreateNSWHealthCheckAssessment()
        {
            return new NSWHealthCheckAssessment();
        }
        ...
        public static ICDAContextNSWHealthCheckAssessment CreateCDAContext()
        {
        ...
        public static INSWHealthCheckAssessmentContext CreateSCSContext()
        {
            return new Context();
        }
        ...
        public static INSWHealthCheckAssessmentContent CreateSCSContent()
        {
            return new Content();
        }
