...
namespace Nehta.VendorLibrary.CDA.Common
{
    ...
    public class ConsumerEnteredHealthSummary : BaseCDAModel
    {
        #region Properties
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public ICDAContextConsumerEnteredHealthSummary CDAContext { get; set; }

        /// <summary>
        /// An IEReferralContent that contains the content for this e-referral record
        /// </summary>
        [DataMember]
        public IConsumerEnteredHealthSummaryContent SCSContent { get; set; }

        /// <summary>
        /// An IDispenseRecordContext that contains the context for this e-referral record
        /// </summary>
        [DataMember]
        public IConsumerEnteredHealthSummaryContext SCSContext { get; set; }
        #endregion
        ...
        public ConsumerEnteredHealthSummary(DocumentStatus documentStatus)
        {
        ...
        /// set to final
        /// </summary>
        public ConsumerEnteredHealthSummary()
        ...
        public static ConsumerEnteredHealthSummary CreateConsumerEnteredHealthSummary()
        {
            return new ConsumerEnteredHealthSummary();
        }
        ...
        public static ICDAContextConsumerEnteredHealthSummary CreateCDAContext()
        {
        ...
        public static IConsumerEnteredHealthSummaryContext CreateSCSContext()
        {
            return new Context();
        }
        ...
        public static IConsumerEnteredHealthSummaryContent CreateSCSContent()
        {
            return new Content();
        }

        /// <summary>
        /// Create allergies and adverse reactions
        /// </summary>
        /// <returns>(IAdverseReactions) AdverseSubstanceReactions</returns>
        public static Reaction CreateAllergyAndAdverseReaction(string substanceOrAgent, List<string> manifestations)
        {
            var reaction = new Reaction();
            reaction.SubstanceOrAgent = substanceOrAgent.IsNullOrEmptyWhitespace() ? null : new CodableText()
            {
                OriginalText = substanceOrAgent
            };
            reaction.ReactionEvent = (manifestations == null || manifestations.Count == 0) ? null : new ReactionEvent()
            {
                Manifestations =
                manifestations.Select(manifestation => new CodableText() {OriginalText = manifestation}).Cast<ICodableText>().ToList()
            };
        ...
        /// </summary>
        /// <returns>(IAdverseReactions) AdverseSubstanceReactions</returns>
        public static IMedication CreateMedication(string medicine, StructuredText directions, string clinicalIndication, string comment)
        {
            var medication = new Medication()
            {
                ...
                Comment = comment,
                Medicine = medicine.IsNullOrEmptyWhitespace() ? null : new CodableText()
                {
        ...
        /// <summary>
        /// Creates a person constrained down to an IAuthorWithRelationship
        /// </summary>
        /// <returns>(IAuthor) Person</returns>
        public static new IAuthorWithRelationship CreateParticipantForAuthor()
        {
