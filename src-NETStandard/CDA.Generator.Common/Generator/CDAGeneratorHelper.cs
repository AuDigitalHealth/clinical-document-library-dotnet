...
namespace Nehta.VendorLibrary.CDA.Generator
{
    ...
    public static partial class CDAGeneratorHelper
    {
        ...
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateAdministrativeObservations(IParticipationDocumentAuthor authorPersonParticipation, IParticipationSubjectOfCare subjectOfCareParticipation, StrucDocText customNarrative, string patientId, INarrativeGenerator narrativeGenerator, List<Coverage2> coverages = null)
        {
          ...
          if (subjectOfCareParticipation != null && subjectOfCareParticipation.Participant != null && subjectOfCareParticipation.Participant.Person != null)
          {
                ...
                subjectOfCareParticipation.Participant.Entitlements != null)
            {
              ...
              if (person.InterpreterRequired?.PreferredLanguage != null && person.InterpreterRequired.PreferredLanguage.Any())
              {
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(IMedications medications, INarrativeGenerator narrativeGenerator, CDADocumentType DocType)
        {
          POCD_MT000040Component3 component = null;
        ...
        internal static List<POCD_MT000040Component5> CreateComponent(List<IImagingExaminationResult> imagingExaminationResults, CDADocumentType? cdaDocumentType, INarrativeGenerator narrativeGenerator)
        {
            ...
            if (imagingExaminationResults != null && imagingExaminationResults.Any())
            {
                foreach (var imagingExaminationResult in imagingExaminationResults)
                {
                    ...
                    {
                        relationshipList.Add(CreateRelationshipForTestResultStatus(imagingExaminationResult.ExaminationResultStatus, cdaDocumentType));
                    }
        ...
        internal static List<POCD_MT000040Component5> CreateComponent(List<SCSModel.Common.PathologyTestResult> pathologyTestResults, CDADocumentType? cdaDocumentType, INarrativeGenerator narrativeGenerator)
        {
            ...
            if (pathologyTestResults != null)
            {
                foreach (var pathologyTestResult in pathologyTestResults)
                {
                    ...
                    {
                        var code = CreateConceptDescriptor("310074003", CodingSystem.SNOMED, "pathology service", null, null, null);
                    ...
                    {
                        relationshipList.Add(CreateRelationshipForTestResultStatus(pathologyTestResult.OverallTestResultStatus, cdaDocumentType));
                    }
                    ...
                    {
                        relationshipList.Add(CreateRelationshipForTestResultConclusion(pathologyTestResult.Conclusion, cdaDocumentType));
                    }
        ...
        internal static POCD_MT000040Component3 CreateComponent(IDiagnosticInvestigationsV1 diagnosticInvestigations, INarrativeGenerator narrativeGenerator)
        {
            ...
            if (diagnosticInvestigations != null)
            {
                ...
                if (diagnosticInvestigations.PathologyTestResult != null && diagnosticInvestigations.PathologyTestResult.Any())
                {
                    componentList.AddRange(CreateComponent(diagnosticInvestigations.PathologyTestResult, CDADocumentType.ServiceReferral, narrativeGenerator));
                }

                // Imaging Examination Result
                if (diagnosticInvestigations.ImagingExaminationResult != null && diagnosticInvestigations.ImagingExaminationResult.Any())
                {
                    componentList.AddRange(CreateComponent(diagnosticInvestigations.ImagingExaminationResult, CDADocumentType.ServiceReferral, narrativeGenerator));
                }

                // Requested Service
                if (diagnosticInvestigations.RequestedService != null && diagnosticInvestigations.RequestedService.Any())
                {
                    component.section.entry = CreateEntry(diagnosticInvestigations.RequestedService, narrativeGenerator);
                }
      ...
      internal static POCD_MT000040Component3 CreateComponent(IEPrescriptionItem item, IParticipationPrescriber prescriber, IParticipationPrescriberOrganisation participationPrescriberOrganisation, IParticipationSubjectOfCare subjectOfCare, INarrativeGenerator narrativeGenerator)
            ...
            if (imagingExaminationResults.Any())
            {
                foreach (var imagingExaminationResult in imagingExaminationResults)
                {
                    ...
                    if (imagingExaminationResult.OverallResultStatus != null)
                        relationshipList.Add(CreateRelationshipForTestResultStatus(imagingExaminationResult.OverallResultStatus, null));
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(ServiceReferralDetail serviceReferralDetail, INarrativeGenerator narrativeGenerator)
        {
            POCD_MT000040Component3 component = null;
            var entryList = new List<POCD_MT000040Entry>();
            ...
            if (serviceReferralDetail != null)
            {
                ...
                component.section.text = serviceReferralDetail.CustomNarrative ?? narrativeGenerator.CreateNarrative(serviceReferralDetail);
        ...
        internal static POCD_MT000040Entry CreateInterpreterRequiredAlert(InterpreterRequiredAlert interpreterRequiredAlert)
        {
            var entry = new POCD_MT000040Entry();
            ...
            if (interpreterRequiredAlert?.PreferredLanguage != null && interpreterRequiredAlert.PreferredLanguage.Any())
            {
                ...
                entry = CreateEntryObservation(x_ActRelationshipEntry.DRIV, CreateConceptDescriptor(CreateCodableText(ServiceReferralSections.InterpreterRequired)), null, anyList, null, null);
        ...
        /// <returns></returns>
        internal static POCD_MT000040Entry CreateRequestServiceEntry(Service requestedService, ICodableText code = null, string subjectOfCareIdentifier = null)
        {
            var relationshipList = new List<POCD_MT000040EntryRelationship>();
            ...
            if (requestedService.ReasonForService != null || !string.IsNullOrWhiteSpace(requestedService.ReasonForServiceDescription))
            {
                relationshipList.Add(CreateEntryRelationshipACT(x_ActRelationshipEntryRelationship.COMP,
                                                                x_ActClassDocumentEntryAct.ACT,
                                                                x_DocumentActMood.EVN,
                                                                false,
                                                                requestedService.ReasonForService != null ? CreateConceptDescriptor(requestedService.ReasonForService) : null,
                                                                !string.IsNullOrWhiteSpace(requestedService.ReasonForServiceDescription) ? CreateStructuredText(requestedService.ReasonForServiceDescription) : null,
                                                                null
                                                                ));
            }
            ...
            {
                entry.act.priorityCode = CreateCodedWithExtensionElement(CreateCodableText(ServiceReferralSections.RequestUrgency));
            }
            ...
            if (requestedService.SubjectOfCareInstructionDescription != null)
            {
                foreach (var subjectOfCareInstructionDescription in requestedService.SubjectOfCareInstructionDescription)
                {
                    relationshipList.Add(CreateEntryRelationshipACT(x_ActRelationshipEntryRelationship.COMP,
                         ...
                         x_DocumentActMood.EVN,
                         false,
                         CreateConceptDescriptor(CreateCodableText(ServiceReferralSections.SubjectOfCareInstructionDescription)),
        ...
        internal static List<POCD_MT000040Entry> CreateRequestedServices(IList<IRequestedService> requestedServices)
        {
            ...
            {
                entryList.AddRange(from Service requestedService in requestedServices select CreateRequestServiceEntry(requestedService));
            }
        ...
        internal static List<POCD_MT000040Entry> CreateRelatedDocument(IList<RelatedDocumentV1> relatedDocuments)
        {
            ...
            if (relatedDocuments != null && relatedDocuments.Any())
            {
                foreach (var relatedDocument in relatedDocuments)
                {
                    ...
                    {
                        typeCode = x_ActRelationshipEntry.COMP,
                        act = CreateActEvent(x_ActClassDocumentEntryAct.ACT, x_DocumentActMood.EVN, CreateConceptDescriptor(CreateCodableText(ServiceReferralSections.RelatedDocument)))
                    };
                    ...
                    entry.act.reference = new[]
                    {
                        new POCD_MT000040Reference
                        {
                            ...
                            externalDocument = new POCD_MT000040ExternalDocument
                            {
                                classCode = ActClassDocument.DOC,
                                moodCode = ActMood.EVN,
                                id = relatedDocument.DocumentTarget?.ID != null  ? CreateIdentifierArray(relatedDocument.DocumentTarget.ID) : null,
                                code = relatedDocument.DocumentDetails?.DocumentType != null ?  CreateConceptDescriptor(relatedDocument.DocumentDetails.DocumentType) : null,
                                text = relatedDocument.DocumentTarget != null ? CreateEncapsulatedData(relatedDocument.DocumentTarget) : null
                            }
                        }
                    };
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(IList<ICurrentService> currentServices, StrucDocText customNarrativeCurrentService, INarrativeGenerator narrativeGenerator)
        {
            POCD_MT000040Component3 component = null;
            var entryList = new List<POCD_MT000040Entry>();
            ...
            if (currentServices != null)
            {
                ...
                component.section.text = customNarrativeCurrentService ?? narrativeGenerator.CreateNarrative(currentServices);
        ...
        internal static POCD_MT000040Entry[] CreateEntry(List<IPendingDiagnosticInvestigation> pendingDiagnosticInvestigation, INarrativeGenerator narrativeGenerator)
        {
            ...
            if (pendingDiagnosticInvestigation != null)
            {
                ...
                foreach (var currentService in pendingDiagnosticInvestigation)
                {
                    ...
                    {
                        entryList.AddRange(from Service service in pendingDiagnosticInvestigation select CreateRequestServiceEntry(service, CreateCodableText(ServiceReferralSections.RequestedService)));
                    }
                }
            }
    ...
    internal static POCD_MT000040Custodian CreateCustodian(IParticipationCustodian custodian)
        ...
        /// <param name="subjectOfCareIdentifier">Subject Of Care Identifier</param>
        /// <returns>POCD_MT000040InformationRecipient</returns>
        internal static POCD_MT000040InformationRecipient CreateInformationRecipient(IParticipationPersonOrOrganisation provider, x_InformationRecipient participationType, string subjectOfCareIdentifier)
        {
            POCD_MT000040InformationRecipient cdaRecipient = null;
            ...
            if (recipient != null)
            {
                cdaRecipient = new POCD_MT000040InformationRecipient
                {
                    ...
                    intendedRecipient =
                      ...
                      {
                          classCode = x_InformationRecipientRole.ASSIGNED,
                          id = provider.Participant != null ? CreateIdentifierArray(provider.Participant.UniqueIdentifier.ToString(), null) : null,
                          addr = CreateAddressArray(recipient.Addresses),
                ...
                {
                    cdaRecipient.intendedRecipient.telecom = CreateTelecomunicationArray(recipient.ElectronicCommunicationDetails);
                }
                ...
                if (recipient.Person?.PersonNames != null)
                {
                    ...
                    cdaRecipient.intendedRecipient.informationRecipient.name = CreatePersonNameArray(recipient.Person.PersonNames);
                }
                ...
                if (recipient.Person?.Identifiers != null && recipient.Person.Identifiers.Any())
                {
                    ...
                    cdaRecipient.intendedRecipient.informationRecipient.asEntityIdentifier =  CreateEntityIdentifier(recipient.Person.Identifiers).ToArray();
                }

                if (recipient.Organisation != null && (recipient.Organisation.Identifiers != null || !string.IsNullOrEmpty(recipient.Organisation.Name)))
                {
                    cdaRecipient.intendedRecipient.receivedOrganization = CreateOrganisation(recipient.Organisation);
                }
                ...
                {
                    cdaRecipient.intendedRecipient.informationRecipient.asEmployment = CreateEmployment(recipient.Person.Organisation);
                }

                if (recipient.RelationshipToSubjectOfCare != null && !subjectOfCareIdentifier.IsNullOrEmptyWhitespace())
                {
                    cdaRecipient.intendedRecipient.informationRecipient.personalRelationship = CreatePersonalRelationship(recipient.RelationshipToSubjectOfCare, subjectOfCareIdentifier);
                }
        ...
        /// <param name="subjectOfCareIdentifier">Subject Of Care Identifier</param>
        /// <returns>CDA participant.</returns>
        internal static POCD_MT000040Participant1 CreateParticipant(IParticipationPersonOrOrganisation participation, ParticipationType participationType, RoleClassAssociative roleClassAssociative, CE functionCode, string subjectOfCareIdentifier)
        {
            POCD_MT000040Participant1 returnParticipant = null;
            ...
            if (participation?.Participant != null)
            {
                ...
                returnParticipant = CreateParticipant(castedParticipation, participationType, roleClassAssociative, functionCode, subjectOfCareIdentifier);
            }
        ...
        /// <param name="subjectOfCareIdentifier">Subject Of Care Identifier</param>
        /// <returns>POCD_MT000040Participant1</returns>
        internal static POCD_MT000040Participant1 CreateParticipant(IParticipation participation, ParticipationType participationType, RoleClassAssociative roleClassAssociative, CE functionCode, string subjectOfCareIdentifier = null)
        {
          POCD_MT000040Participant1 returnParticipant = null;
                  ...
                  new POCD_MT000040AssociatedEntity
                  {
                    ...
                    associatedPerson = participation.Participant.Person != null 
                            ? new POCD_MT000040Person
                            {
                               ...
                               personalRelationship = participation.Participant?.RelationshipToSubjectOfCare != null && !subjectOfCareIdentifier.IsNullOrEmptyWhitespace() ? CreatePersonalRelationship(participation.Participant.RelationshipToSubjectOfCare, subjectOfCareIdentifier) : null,
                               // Person Name
        ...
        /// <param name="subjectOfCareIdentifier">Subject Of Care Identifier</param>
        /// <returns>POCD_MT000040Performer2</returns>
        internal static POCD_MT000040Performer2 CreatePerformer(IParticipationPersonOrOrganisation participation, string subjectOfCareIdentifier)
        {
            POCD_MT000040Performer2 performer = null;
            ...
            if (participation?.Participant != null)
            {
                ...
                performer = CreatePerformer(castedParticipation, ParticipationPhysicalPerformer.PRF, castedParticipation.Participant.UniqueIdentifier.ToString(), subjectOfCareIdentifier);
            }
            return performer;
        }
        ...
        /// </summary>
        /// <returns>POCD_MT000040Performer2</returns>
        internal static POCD_MT000040Performer2 CreatePerformer(IParticipation participation, ParticipationPhysicalPerformer typeCode, string id = null, string subjectOfCareIdentifier = null)
        {
          POCD_MT000040Performer2 performer = null;
        ...
        private static PersonalRelationship[] CreatePersonalRelationship(ICodableText codableText, string subjectOfCareIdentifier)
        {
      ...
      private static POCD_MT000040EntryRelationship CreateEntryRelationshipObservation(
            ...
            CS testStatus, ITestResultGroup testResultGroup, CDADocumentType? cdaDocumentType)
        {
            ...
            if (testResultGroup != null && testResultGroup.Results != null && testResultGroup.Results.Any())
            {
                foreach (var testResult in testResultGroup.Results)
                {
                    ...
                    {
                        relationships.Add(CreateRelationshipForTestResultStatus(testResult.ResultStatus, cdaDocumentType));
                    }

                    //COMMENTS
                    if (testResult.Comments != null && testResult.Comments.Any())
                    {
                        var codeResultComment = CreateConceptDescriptor("281296001", CodingSystem.SNOMED, "result comments", null, null, null);
                    ...
                    {
                        var codeReferenceRangeComments = CreateConceptDescriptor("281298000", CodingSystem.SNOMED, "reference range comments", null, null, null);
        ...
        private static POCD_MT000040EntryRelationship CreateRelationshipForTestResultConclusion(String conclusion, CDADocumentType? cdaDocumentType)
        {
            POCD_MT000040EntryRelationship relationship = null;
        ...
        private static POCD_MT000040EntryRelationship CreateRelationshipForTestResultStatus(ICodableText resultStatus, CDADocumentType? cdaDocument)
        {
        ...
        private static POCD_MT000040Entry CreateEntryActEventInterval(CD code, ED ecapsulatedData, List<POCD_MT000040Performer2> addresseePerformers, CdaInterval duration, x_DocumentActMood actMoodCode)
        {
        ...
        internal static CE CreateCodedWithExtensionElement(string code, CodingSystem? codingSystem, string displayName, string originalText, List<ICodableTranslation> codableTranslations, NullFlavour? nullFlavor, List<QualifierCode> qualifierCodes = null)
        {
        ...
        internal static CE CreateCodedWithExtensionElement(ICodableText code)
        {
            ...
            if (code != null)
            {
                ce = CreateCodedWithExtensionElement(code.Code, code.CodeSystemCode, code.CodeSystemName, code.CodeSystemVersion, code.DisplayName, code.OriginalText, code.Translations, code.NullFlavour, code.QualifierCodes);
            }
        ...
        internal static CE CreateCodedWithExtensionElement(string code, string codeSystemCode, string codeSystemName, string codeSystemVersion, string displayName, string originalText, List<ICodableTranslation> codableTranslations, NullFlavour? nullFlavor, List<QualifierCode> qualifierCodes = null)
        {
        ...
        private static CS CreateCodeSystem(string code, string codeSystem, string codeSystemName, string displayName, string originalText, NullFlavour? nullFlavor, List<QualifierCode> qualifierCodes = null)
        {
          CS cs = null;
        ...
        internal static CD CreateConceptDescriptor(string code, CodingSystem? codingSystem, string displayName, string originalText, string codeSystemVersion, NullFlavour? nullFlavor, List<QualifierCode> qualifierCodes = null)
        {
        ...
        internal static CD CreateConceptDescriptor(string code, CodingSystem? codingSystem, string displayName, string originalText, List<QualifierCode> qualifierCodes = null)
        {
          return CreateConceptDescriptor(code, codingSystem, displayName, originalText, null, null, qualifierCodes);
        }

        private static CD CreateConceptDescriptor(string code, string codeSystem, string codeSystemName, string displayName, string originalText, NullFlavour? nullFlavor, List<QualifierCode> qualifierCodes = null)
        {
          ICodableText codableText = new CodableText();
          codableText.Code = code;
...
//                cd.codeSystem = CodingSystem.AMTV3.GetAttributeValue<NameAttribute, string>(x => x.Code);
        ...
        public static CV CreateCodedValue(string code, CodingSystem? codingSystem, string displayName, string originalText, string codeSystemVersion, NullFlavour? nullFlavor, List<QualifierCode> qualifierCodes = null)
        {
          CV cv = null;
        ...
        public static List<Coverage2> CreateEntitlements(ICollection<Entitlement> entitlements, string id, RoleClass roleClass, ParticipationType participationType)
        {
            ...
            using (var xmlWriter = XmlWriter.Create(stringBuilder))
            {
              if (xmlWriter != null)
              {
                try
                {
				  ...
				  // This was commented out in the App.config so assuming it's not being used - Justin Middler - 14/08/2019
                  var styleSheet =  string.Empty; //ConfigurationManager.AppSettings["XSLStylesheet"];
