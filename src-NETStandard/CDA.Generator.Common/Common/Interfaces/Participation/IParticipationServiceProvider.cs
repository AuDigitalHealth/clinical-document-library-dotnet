...
namespace Nehta.VendorLibrary.CDA.SCSModel
{
    ...
    /// </summary>
    public interface IParticipationServiceProvider
    {       
        /// <summary>
        /// The time interval during which the participation in 0..1 performer/time the health care event occurred.
        /// </summary>
        [CanBeNull]
        [DataMember]
        ...
        [CanBeNull]
        [DataMember]
        IServiceProvider Participant { get; set; }

        /// <summary>
        /// Validates this Participation Service Provider
        /// </summary>
