...
{
    /// <summary>
    /// The IParticipationUploadAuthoriser 
    /// </summary>
     public interface IParticipationUploadAuthoriser
    {
        /// <summary>
        ...
        [CanBeNull]
        [DataMember]
        IUploadAuthoriser Participant { get; set; }

        /// <summary>
        /// Validates this Participation Upload Authoriser
        /// </summary>
