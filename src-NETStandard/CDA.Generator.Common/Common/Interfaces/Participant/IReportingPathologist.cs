...
{
    /// <summary>
    /// The IReportingPathologist interface encapsulates all the properties that CDA requires for a participant
    /// </summary>
    public interface IReportingPathologist
    {
        /// <summary>
        ...
        /// <summary>
        /// Validates this Reporting Pathologist
        /// </summary>
