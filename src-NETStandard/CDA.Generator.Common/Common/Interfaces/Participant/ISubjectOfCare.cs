...
{
    /// <summary>
    /// The ISubjectOfCare interface contains all the properties that CDA has identified for a subject of care
    /// </summary>
    public interface ISubjectOfCare
    {
        /// <summary>
        ...
        /// </summary>
        [CanBeNull]
        IPersonSubjectOfCare Person { get; set; }
