...
{
    /// <summary>
    /// The IDispenser interface contains all the properties that CDA has identified for a dispenser
    /// </summary>
    public interface IDispenser
    {
        ...
        /// <summary>
        /// The person responsible for dispensing the medication
        /// </summary>
        [CanBeNull]
        IPersonDispenser Person { get; set; }

        /// <summary>
        /// Validates this IDispenser
        /// </summary>
