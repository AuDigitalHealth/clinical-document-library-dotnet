...
{
    /// <summary>
    /// The IAuthorisee interface encapsulates all the properties that CDA requires for a participant
    /// </summary>
    public interface IReportingRadiologist
    {
        /// <summary>
        ...
        /// <summary>
        /// Validates this ReportingRadiologist
        /// </summary>
