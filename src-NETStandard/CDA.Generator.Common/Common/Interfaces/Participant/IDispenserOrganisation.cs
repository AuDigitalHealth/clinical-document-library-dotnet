...
{
    /// <summary>
    /// The IDispenserOrganisation interface contains all the properties that CDA has identified for a dispenser organisation
    /// </summary>
    public interface IDispenserOrganisation
    {
        /// <summary>
        ...
        /// <summary>
        /// Validates this IDispenserOrganisation
        /// </summary>
        ...
        /// <summary>
        /// Validates this IDispenserOrganisation for ATS
        /// </summary>
        /// <param name="path">The path to this object as a string</param>
        /// <param name="messages">the validation messages, these may be added to within this method</param>
