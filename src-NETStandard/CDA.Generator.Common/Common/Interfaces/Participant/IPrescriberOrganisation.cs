...
{
    /// <summary>
    /// The IPrescriberOrganisation interface contains all the properties that CDA has identified for a prescriber organisation
    /// </summary>
    public interface IPrescriberOrganisation
    {
        /// <summary>
        ...
        /// <summary>
        /// Validates this CDA Context for this prescriber organisation
        /// </summary>
