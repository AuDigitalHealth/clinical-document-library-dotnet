...
{
    /// <summary>
    /// The IInformationRecipient interface encapsulates all the properties that CDA requires for a participant
    /// </summary>
    public interface IInformationRecipient
    {
        ...
        /// <summary>
        /// The addresses of the participant
        /// </summary>
        [CanBeNull]
