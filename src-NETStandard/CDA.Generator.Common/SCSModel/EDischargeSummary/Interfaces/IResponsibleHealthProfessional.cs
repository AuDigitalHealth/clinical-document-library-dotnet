...
{
    /// <summary>
    /// The IResponsibleHealthProfessional interface encapsulates all the properties that CDA requires for a participant
    /// </summary>
    public interface IResponsibleHealthProfessional
        {
        /// <summary>
        /// A list of addresses
        /// </summary>
        ...
        /// <summary>
        /// Validates this Responsible Health Professional Participant
        /// </summary>
