...
{
    /// <summary>
    /// The IFacility interface contains all the properties that CDA has identified for a Facility
    /// </summary>
    public interface IFacility 
    {
        ...
        /// <summary>
        /// The organization responsible for dispensing the medication
        /// </summary>
        [CanBeNull]
        IOrganisation Organisation { get; set; }

        /// <summary>
        /// Validates this IFacility
        /// </summary>
