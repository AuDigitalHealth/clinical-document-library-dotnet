...
{
    /// <summary>
    /// The Nominated Primary Health Care Provider interface encapsulates all the properties that CDA requires for a participant
    /// </summary>
    public interface INominatedPrimaryHealthCareProvider
        {
        /// <summary>
        /// A list of addresses
        /// </summary>
