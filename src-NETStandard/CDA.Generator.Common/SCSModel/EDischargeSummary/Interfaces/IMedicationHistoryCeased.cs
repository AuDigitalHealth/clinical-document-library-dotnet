...
{
    /// <summary>
    /// The IMedicationHistoryCeased interface encapsulates medication information that is used to populate medications 
    /// related sections / information with CDA documents
    /// </summary>
    public interface IMedicationHistoryCeased
    {
        /// <summary>
        /// Item Status
        /// </summary>
        ...
        /// <summary>
        /// Validates this IMedicationHistoryCeased object
        /// </summary>
