...
{
    /// <summary>
    /// This interface encapsulates all the CDA specific context for an Prescription Request
    /// </summary>
    public interface ICDAContextPrescriptionRequestContent
    {
        #region Properties
        ...
        #region Validation
        /// <summary>
        /// Validates this CDA Context for this Prescription Request
        /// </summary>
