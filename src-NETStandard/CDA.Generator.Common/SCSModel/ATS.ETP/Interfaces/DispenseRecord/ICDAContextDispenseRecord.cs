...
{
    /// <summary>
    /// This interface encapsulates all the CDA specific context for an Dispense Record 
    /// </summary>
    public interface ICDAContextDispenseRecord
    {
        #region Properties
        ...
        #region Validation
        /// <summary>
        /// Validates this CDA Context for this Dispense Record 
        /// </summary>
