...
{
  /// <summary>
  /// Models a Vaccine Administration Entry for Medciare Overview  
  /// </summary>
  public class VaccineAdministrationEntry
  {
      #region Properties
      ...
      [CanBeNull]
      [DataMember]
      public ISO8601DateTime DateVaccinationReceived { get; set; }

      #endregion

      #region Constructors
      internal VaccineAdministrationEntry()
      {
      }
      #endregion
      ...
      /// <summary>
      /// Validate the SCS Content for the Vaccine Administration Entry 
      /// </summary>
      ...
      public void Validate(string path, List<ValidationMessage> messages)
      {
        ...
        vb.ArgumentRequiredCheck("DateVaccinationReceived", DateVaccinationReceived);
