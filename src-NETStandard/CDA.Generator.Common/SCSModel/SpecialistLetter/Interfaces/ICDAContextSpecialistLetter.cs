...
{
    /// <summary>
    /// This interface encapsulates all the CDA specific context for an specialist letter
    /// </summary>
    public interface ICDAContextSpecialistLetter
    {
        #region Properties
        ...
        #region Validation
        /// <summary>
        /// Validate the CDA Context for this specialist letter
        /// </summary>
