...
{
    /// <summary>
    /// This class is designed to encapsulate the properties within a CDA document that make up an ConsumerQuestionnaire 
    /// </summary>
    [Serializable]
    [DataContract]
    public class Questionnaire
    {
      ...
      public List<AssessmentItem> AssessmentItems { get; set; }
        ...
        public void Validate(string path, List<ValidationMessage> messages)
        {
          ...
          if (vb.ArgumentRequiredCheck("AssessmentItems", AssessmentItems))
          {
