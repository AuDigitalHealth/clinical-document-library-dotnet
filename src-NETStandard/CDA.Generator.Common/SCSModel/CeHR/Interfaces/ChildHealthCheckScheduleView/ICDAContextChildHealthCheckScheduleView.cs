...
{
  /// <summary>
  /// An ICDAContextChildHealthCheckScheduleView interface
  /// </summary>
  public interface ICDAContextChildHealthCheckScheduleView
    {
        #region Properties
        ...
        #region Validation
        /// <summary>
        /// Validate the CDA Context for this ICDAContextChildHealthCheckScheduleView
        /// </summary>
