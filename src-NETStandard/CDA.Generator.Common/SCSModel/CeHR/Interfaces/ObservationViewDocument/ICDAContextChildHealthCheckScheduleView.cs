...
{
  /// <summary>
  /// An ICDAContextObservationViewDocument interface
  /// </summary>
  public interface ICDAContextObservationViewDocument
    {
        #region Properties
        ...
        #region Validation
        /// <summary>
        /// Validate the CDA Context for this ICDAContextObservationViewDocument
        /// </summary>
