...
{
    /// <summary>
  /// An ICDAContextConsumerQuestionnaire interface
    /// </summary>
    public interface ICDAContextConsumerQuestionnaire
    {
        #region Properties
        ...
        #region Validation
        /// <summary>
        /// Validate the CDA Context for this ICDAContextConsumerQuestionnaire
        /// </summary>
