...
{
    /// <summary>
    /// This interface encapsulates all the CDA specific context for an ICDAContextConsumerEnteredNotes
    /// </summary>
    public interface ICDAContextConsumerEnteredNotes
    {
        #region Properties
        ...
        #region Validation
        /// <summary>
        /// Validate the CDA Context for this ICDAContextConsumerEnteredNotes
        /// </summary>
