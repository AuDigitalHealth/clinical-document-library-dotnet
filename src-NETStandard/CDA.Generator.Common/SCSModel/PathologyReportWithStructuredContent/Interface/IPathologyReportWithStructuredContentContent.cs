...
namespace Nehta.VendorLibrary.CDA.SCSModel.Pathology
{
      ...
      /// </summary>
       public interface IPathologyReportWithStructuredContentContent
      {
          /// <summary>
          ...
          [CanBeNull]
          [DataMember]
          StrucDocText CustomNarrativePathologyReportWithStructuredContent { get; set; }
          ...
          [CanBeNull]
          [DataMember]
          IList<Common.PathologyTestResult> PathologyTestResult { get; set; }
