...
{
  /// <summary>
  /// This interface encapsulates all the CDA specific context for an ICDAContextConsumerEnteredHealthSummary
  /// </summary>
    public interface ICDAContextConsumerEnteredHealthSummary
    {
        #region Properties
        ...
        #region Validation
        /// <summary>
        /// Validate the CDA Context for this ICDAContextConsumerEnteredHealthSummary
        /// </summary>
