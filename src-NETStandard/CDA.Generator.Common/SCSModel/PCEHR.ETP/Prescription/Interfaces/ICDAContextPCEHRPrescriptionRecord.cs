...
{
    /// <summary>
  /// This interface encapsulates all the CDA specific context for an Prescription Record
    /// </summary>
  public interface ICDAContextPCEHRPrescriptionRecord
    {
        #region Properties
        ...
        /// Parent Document ID
        /// </summary>
        List<ParentDocument> ParentDocuments { get; set; }
        ...
        #region Validation
        /// <summary>
        /// Validates this CDA Context for this Prescription Record
        /// </summary>
