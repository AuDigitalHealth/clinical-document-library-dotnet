...
namespace CDA.Generator.Common.SCSModel.PCEHR.ETP.Interfaces.DispenseRecord
{
    /// <summary>
    /// This interface encapsulates all the SCS specific content for a dispense record
    /// </summary>
    public interface IPCEHRDispenseRecordContent
    {
        /// <summary>
        ...
        /// </summary>
        [CanBeNull]
        IPCEHRDispenseItem DispenseItem { get; set; }
