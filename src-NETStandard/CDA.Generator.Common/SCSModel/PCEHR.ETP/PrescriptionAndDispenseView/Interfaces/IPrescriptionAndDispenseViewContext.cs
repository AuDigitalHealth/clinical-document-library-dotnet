...
{
  /// <summary>
  /// This interface encapsulates all the SCS specific context for a Prescription Record
  /// </summary>
  public interface IPrescriptionAndDispenseViewContext
  {
    /// <summary>
    /// The Author Authoring Device Author
    /// </summary>
    [CanBeNull]
    ...
    /// <summary>
    /// Validates this Prescription Record context
    /// </summary>
